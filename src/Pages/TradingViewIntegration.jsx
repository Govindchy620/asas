          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button 
                ...
                className="relative px-10 py-4 bg-white text-black font-bold text-base transition-all hover:bg-[#2962ff] hover:text-white active:scale-95 flex items-center gap-3">
               ...
               <div className="relative p-8 bg-[#1c212d] border border-white/20 shadow-2xl overflow-hidden group rounded-2xl">
                  ...
                  <div className="space-y-6">
                     ...
                     <button 
                        ...
                        className="w-full py-4 bg-white text-black font-bold hover:bg-[#2962ff] hover:text-white transition-all text-sm uppercase tracking-tight rounded-xl">
                        Link Your Account
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button 
                  onClick={() => window.open('https://trade.fxcelite.com/login', '_blank')}
                  className="relative px-12 py-5 bg-white text-black font-bold text-lg transition-all shadow-[0_15px_40px_-15px_rgba(41,98,255,0.6)] uppercase tracking-tight italic hover:-translate-y-1 rounded-xl">
