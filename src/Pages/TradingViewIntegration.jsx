    ...
    <div className="bg-[#131722] text-white font-sans selection:bg-[#2962ff]/30 overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-2 pb-3 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-sm bg-[#2962ff]/20 border border-[#2962ff]/50 backdrop-blur-xl mb-8">
            ...
            <span className="text-xs font-normal uppercase tracking-[0.2em] text-white">Integrated Visualization Module</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button 
                ...
                className="relative px-10 py-4 bg-white text-black font-normal text-base transition-all hover:bg-[#2962ff] hover:text-white active:scale-95 flex items-center gap-3">
                Connect to TradingView <ExternalLink size={18} />
              </button>
            </div>
            <p className="text-[#2962ff] text-sm font-normal uppercase tracking-[0.2em] italic animate-pulse font-mono">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
               <div className="space-y-6">
                 <h2 className="text-3xl md:text-4xl font-normal text-white uppercase tracking-tight leading-tight italic border-b-4 border-[#2962ff] pb-3 inline-block">What is TradingView <br/> Integration?</h2>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 text-center space-y-4">
            <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase italic leading-tight">Why Use TradingView for <br/> Forex Trading?</h2>
            <p className="text-[#2962ff] text-sm font-normal uppercase tracking-[0.2em] font-mono">[ Beyond the Standard Terminal ]</p>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-8 space-y-10">
               <div className="space-y-4">
                 <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic">Key Features of <br/> the Platform</h2>
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 bg-[#1c212d] border border-white/20 shadow-2xl overflow-hidden group rounded-2xl">
                  ...
                  <h3 className="text-xl font-normal text-white mb-6 tracking-tight uppercase border-b border-white/20 pb-4">Hybrid Edge</h3>
                  <div className="space-y-6">
                     <p className="text-base text-white font-normal leading-tight italic bg-[#2962ff]/20 p-4 rounded-lg border border-[#2962ff]/30">
                     ...
                     <button 
                        ...
                        className="w-full py-4 bg-white text-black font-normal hover:bg-[#2962ff] hover:text-white transition-all text-sm uppercase tracking-tight rounded-xl">
                        Link Your Account
                     </button>
                  </div>
               </div>
      ...
      <section className="py-24 bg-black border-y border-white/10">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16 space-y-2">
             <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic">TradingView vs. MetaTrader 5</h2>
             <p className="text-white/80 text-sm font-normal uppercase tracking-[0.2em] italic underline decoration-[#2962ff] decoration-4 underline-offset-[8px]">Undisputed Leaders</p>
          </div>
            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              <thead>
                <tr className="bg-[#2962ff]/30">
                  <th className="p-5 text-sm font-normal text-white uppercase italic tracking-widest border-r border-white/20">Feature</th>
                  <th className="p-5 text-sm font-normal text-white uppercase italic tracking-widest border-r border-white/20">TradingView</th>
                  <th className="p-5 text-sm font-normal text-white uppercase italic tracking-widest">MetaTrader 5</th>
                </tr>
              </thead>
              <tbody className="text-sm md:text-base font-mono">
                {[
                  ...
                  <tr key={i} className="group hover:bg-white/10 transition-colors border-b border-white/20">
                    <td className="p-5 font-normal text-white/90 border-r border-white/20 uppercase tracking-tight">{row.f}</td>
                    <td className="p-5 font-normal text-white border-r border-white/20 italic group-hover:text-[#2962ff] transition-colors">{row.c}</td>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase italic leading-tight">How to Start Trading <br/> with TradingView</h2>
            <p className="text-[#2962ff] text-sm font-normal uppercase tracking-[0.2em] font-mono">[ Technical Handshake Sequence ]</p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              <div key={i} className="group relative p-8 bg-[#1c212d] border border-white/20 hover:border-[#2962ff] transition-all duration-500 text-center rounded-2xl shadow-lg mt-8 lg:mt-0">
                 <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 bg-[#131722] border-2 border-[#2962ff] flex items-center justify-center font-normal text-white text-lg group-hover:bg-[#2962ff] group-hover:text-white transition-all rounded-xl shadow-[0_0_15px_#2962ff]">
                    {step.n}
                 </div>
                 ...
                 <h4 className="text-xl font-normal text-white mb-3 uppercase tracking-tight italic">{step.t}</h4>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12">
             <div className="p-10 bg-black border border-white/20 relative group overflow-hidden shadow-2xl rounded-3xl">
                ...
                <div className="relative z-10 space-y-8">
                   <div className="flex items-center gap-5">
                      ...
                      <h2 className="text-2xl font-normal text-white tracking-tight uppercase italic">Security & Reliability</h2>
                   </div>
             ...
             <div className="space-y-10 lg:p-8">
                <div className="space-y-4">
                  <h2 className="text-3xl md:text-4xl font-normal text-white tracking-tight uppercase italic leading-tight">Who is <br/> TradingView For?</h2>
                  <p className="text-[#2962ff] font-normal uppercase tracking-[0.3em] text-xs font-mono">[ Target Visualization Profiles ]</p>
                </div>
      ...
      <section className="py-24 bg-[#0d1017] text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic">Why FXCELITE is the Best <br/> Choice for TradingView?</h2>
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button 
                  onClick={() => window.open('https://trade.FXCELITE.com/login', '_blank')}
                  className="relative px-12 py-5 bg-white text-black font-normal text-lg transition-all shadow-[0_15px_40px_-15px_rgba(41,98,255,0.6)] uppercase tracking-tight italic hover:-translate-y-1 rounded-xl">
                  Unlock TradingView Power
                </button>
              </div>
              <div className="space-y-4">
                <p className="text-[#2962ff] font-normal uppercase tracking-[0.4em] text-xs italic font-mono">Command the charts. Trade with full power today!</p>
      ...
      <section className="py-24 border-t border-white/10 bg-black">
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-16 space-y-3">
            <h2 className="text-3xl md:text-4xl font-normal text-white tracking-tight uppercase italic font-mono">[ SYNC FAQ ]</h2>
            <p className="text-white/80 font-normal uppercase tracking-widest text-sm italic">Visualization Knowledge Base</p>
          </div>
