          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button className="relative px-10 py-4 rounded-xl bg-white text-black font-bold text-base transition-all active:scale-95 flex items-center gap-3">
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-32 space-y-8">
               <div className="relative p-8 rounded-3xl bg-[#0B0E2A] border border-white/10 shadow-2xl overflow-hidden group">
                  ...
                  <div className="space-y-6">
                     ...
                     <button className="w-full py-4 rounded-xl bg-white text-black font-bold hover:bg-indigo-400 transition-all text-base shadow-lg">
                        Open Live Account
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button className="relative px-12 py-5 rounded-xl bg-white text-black font-bold text-lg transition-all shadow-[0_15px_40px_-15px_rgba(99,102,241,0.4)] hover:-translate-y-1">
