          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button 
                ...
                className="relative px-10 py-4 bg-white text-black font-bold text-base transition-all hover:scale-[1.03] active:scale-95 shadow-xl flex items-center gap-3 uppercase tracking-tight italic rounded-xl">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 bg-black border border-emerald-500/30 shadow-2xl overflow-hidden group rounded-2xl">
                  ...
                  <div className="space-y-6">
                     ...
                     <button 
                        onClick={() => window.open('https://trade.fxcelite.com/login', '_blank')}
                        className="w-full py-4 bg-white text-black font-bold hover:bg-emerald-500 transition-all text-sm shadow-xl shadow-emerald-500/20 uppercase tracking-tight italic rounded-xl">
                        Deposit Today
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button 
                  onClick={() => window.open('https://trade.fxcelite.com/login', '_blank')}
                  className="relative px-12 py-5 bg-white text-black font-bold text-lg transition-all shadow-[0_15px_40px_-15px_rgba(16,185,129,0.4)] uppercase tracking-tight italic hover:-translate-y-1 rounded-xl">
                  Deposit Today
                </button>
              </div>
              <div className="space-y-4">
