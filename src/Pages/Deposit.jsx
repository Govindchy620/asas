    ...
    <div className="bg-[#020410] text-slate-300 font-sans selection:bg-emerald-500/30 overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-2 pb-3 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-sm border-l-2 border-emerald-500 bg-emerald-500/5 backdrop-blur-xl mb-8 animate-fade-in">
            ...
            <span className="text-xs font-normal uppercase tracking-[0.2em] text-emerald-400">Funding Pipeline v9.0-Active</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button 
                ...
                className="relative px-10 py-4 bg-white text-black font-normal text-base transition-all hover:scale-[1.03] active:scale-95 shadow-xl flex items-center gap-3 uppercase tracking-tight italic rounded-xl">
                Fund Your Account Now <Zap size={20} />
              </button>
            </div>
            <p className="text-emerald-400 text-sm font-normal uppercase tracking-[0.2em] italic animate-pulse">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
               <div className="space-y-6">
                 <h2 className="text-3xl md:text-5xl font-normal text-white uppercase tracking-tight leading-tight italic underline decoration-emerald-500 decoration-4 underline-offset-[8px]">Forex Deposit <br/> Process Explained</h2>
               ...
               <div className="relative border border-white/10 shadow-2xl bg-[#0B0E2A] rounded-2xl overflow-hidden">
                 ...
                 <div className="absolute bottom-6 left-6 right-6 p-6 bg-black/90 backdrop-blur-xl border border-white/10 rounded-xl">
                    ...
                    <div className="mt-4 flex items-center gap-3">
                      ...
                      <span className="text-emerald-400 font-normal uppercase tracking-widest text-[10px] font-mono">Automated Conversion Active</span>
                    </div>
                 </div>
               </div>
            </div>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 text-center space-y-4">
            <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase italic leading-tight">Why Choose FXCELITE for <br/> Account Funding?</h2>
            <p className="text-amber-500 text-sm font-normal uppercase tracking-[0.2em]">The Ultimate Speed in Liquidity</p>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-8 space-y-10">
               <div className="space-y-4">
                 <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic">Key Features of our <br/> Funding System</h2>
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 bg-black border border-emerald-500/30 shadow-2xl overflow-hidden group rounded-2xl">
                  ...
                  <h3 className="text-xl font-normal text-white mb-6 tracking-tight uppercase border-b border-white/10 pb-4 font-mono">Liquidity Access</h3>
                  <div className="space-y-6">
                     <p className="text-base text-emerald-400 font-normal leading-tight italic">
                     ...
                     <button 
                        onClick={() => window.open('https://trade.FXCELITE.com/login', '_blank')}
                        className="w-full py-4 bg-white text-black font-normal hover:bg-emerald-500 transition-all text-sm shadow-xl shadow-emerald-500/20 uppercase tracking-tight italic rounded-xl">
                        Deposit Today
                     </button>
                  </div>
               </div>
      ...
      <section className="py-24 relative bg-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase italic leading-tight">Step by Step <br/> Forex Deposit</h2>
            <p className="text-emerald-400 text-sm font-normal uppercase tracking-[0.2em]">Follow this sequence to get started</p>
          </div>
          ...
          <div className="grid lg:grid-cols-5 gap-6 relative">
            ...
            {[
              ...
              <div key={i} className="group relative p-6 bg-white/[0.02] border border-white/5 hover:border-emerald-500/50 transition-all duration-500 text-center rounded-2xl shadow-lg mt-6 lg:mt-0">
                 <div className="absolute -top-5 left-1/2 -translate-x-1/2 w-10 h-10 bg-black border-2 border-emerald-500/20 flex items-center justify-center font-normal text-emerald-400 text-sm group-hover:bg-emerald-400 group-hover:text-black transition-all rounded-lg">
                    {step.n}
                 </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
             <div className="p-8 md:p-10 bg-black border border-white/10 relative group overflow-hidden shadow-2xl rounded-3xl">
                ...
                <div className="relative z-10 space-y-8">
                   <div className="flex items-center gap-4">
                      ...
                      <h2 className="text-2xl font-normal text-white tracking-tight uppercase italic underline decoration-emerald-500 decoration-4 underline-offset-[8px]">Security & Reliability</h2>
                   </div>
             ...
             <div className="space-y-10 lg:p-8">
                <div className="space-y-4">
                  ...
                  <p className="text-amber-500 font-normal uppercase tracking-[0.2em] text-xs font-mono">Liquidity Access Profiles</p>
                </div>
      ...
      <section className="py-24 bg-[#02030d] text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic">Why FXCELITE is the Best <br/> Choice for Funding?</h2>
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button 
                  onClick={() => window.open('https://trade.FXCELITE.com/login', '_blank')}
                  className="relative px-12 py-5 bg-white text-black font-normal text-lg transition-all shadow-[0_15px_40px_-15px_rgba(16,185,129,0.4)] uppercase tracking-tight italic hover:-translate-y-1 rounded-xl">
                  Deposit Today
                </button>
              </div>
              <div className="space-y-4">
                <p className="text-emerald-400 font-normal uppercase tracking-[0.3em] text-xs italic font-mono">Your trading capital, ready when you are.</p>
      ...
      <section className="py-24 border-t border-white/5 bg-black">
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-16 space-y-3">
            <h2 className="text-3xl md:text-4xl font-normal text-white tracking-tight uppercase italic">Deposit FAQ</h2>
