               ...
               <div className="relative p-8 bg-black border border-white/20 shadow-[0_20px_60px_-15px_rgba(59,130,246,0.3)] group overflow-hidden rounded-3xl">
                  ...
                  <div className="space-y-6 relative z-10">
                     ...
                     <button 
                        ...
                        className="w-full py-4 bg-white text-black font-bold hover:bg-blue-600 hover:text-white transition-all text-sm uppercase tracking-tight italic shadow-lg rounded-xl">
                        Try Demo Account
                     </button>
                  </div>
               </div>
