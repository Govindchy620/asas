          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
               <div className="space-y-6">
                 <h2 className="text-3xl md:text-5xl font-normal text-white uppercase tracking-tight leading-tight italic border-l-4 border-blue-600 pl-4">How to Reach the <br/> FXCELITE Team</h2>
               ...
               <div className="relative border border-white/20 shadow-2xl bg-[#0a0f24] overflow-hidden rounded-3xl p-1">
                 ...
                 <div className="absolute bottom-6 left-6 right-6 p-6 bg-black/90 border border-white/20 backdrop-blur-xl shadow-xl rounded-xl">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="text-white text-lg font-normal tracking-tight uppercase italic">Global Sync</span>
                    </div>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 text-center space-y-4">
            <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase italic leading-tight">Our Contact <br/> Details</h2>
            <p className="text-blue-400 text-sm font-normal uppercase tracking-[0.2em] font-mono">[ DIRECT_NODE_ACCESS ]</p>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-8 space-y-10">
               <div className="space-y-4">
                 <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic">Why Get in Touch <br/> with Our Team?</h2>
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 bg-black border border-white/20 shadow-[0_20px_60px_-15px_rgba(59,130,246,0.3)] group overflow-hidden rounded-3xl">
                  ...
                  <h3 className="text-xl font-normal text-white mb-6 tracking-tight uppercase border-b border-white/20 pb-4 italic">Support Access</h3>
                  <div className="space-y-6 relative z-10">
                     ...
                     <button 
                        ...
                        className="w-full py-4 bg-white text-black font-normal hover:bg-blue-600 hover:text-white transition-all text-sm uppercase tracking-tight italic shadow-lg rounded-xl">
                        Try Demo Account
                     </button>
                  </div>
               </div>
      ...
      <section className="py-24 relative bg-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-blue-400 text-sm font-normal uppercase tracking-[0.2em] font-mono">[ Connection Protocol Initiation ]</p>
          ...
          <div className="grid lg:grid-cols-3 gap-6 relative">
            ...
            {[
              ...
              <div key={i} className="group relative p-6 bg-white/[0.05] border border-white/10 hover:border-blue-500/50 transition-all duration-500 text-center shadow-xl rounded-3xl mt-8 lg:mt-0">
                 <div className="absolute -top-5 left-1/2 -translate-x-1/2 w-10 h-10 bg-black border-2 border-blue-500/50 flex items-center justify-center font-normal text-white text-sm group-hover:bg-blue-600 group-hover:text-white transition-all shadow-[0_0_15px_rgba(59,130,246,0.5)] rounded-full">
                    {step.n}
                 </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
                      ...
                      {[
                        ...
                        <div key={idx} className="flex gap-5 group/item items-start">
                           ...
                           <div className="space-y-1">
                             <h4 className="text-white font-normal uppercase text-sm italic tracking-tight">{item.t}</h4>
             ...
             <div className="order-1 lg:order-2 space-y-8">
               <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-[0.9] italic">Technical Issues: <br/> Trading Platform <br/> Troubleshooting</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            //   { l: "New Traders", d: "Who need to get assistance on the basics of their trading accounts and navigation of the trading platforms.", icon: <Sparkles /> },
              ...
              <div key={i} className="group relative p-6 bg-white/[0.02] border border-white/10 hover:border-indigo-500/40 transition-all duration-500 text-center shadow-xl rounded-2xl">
                  ...
                  <h4 className="text-lg font-normal text-white mb-2 tracking-tight leading-tight uppercase italic">{item.l}</h4>
      ...
      <section className="py-24 bg-black text-center relative overflow-hidden border-t border-white/10">
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              ...
              <div className="space-y-4">
                <p className="text-indigo-400 font-normal uppercase tracking-[0.3em] text-xs italic font-mono max-w-xl mx-auto">Your success is our mission. Experience the best support!</p>
      ...
      <section className="py-24 border-t border-white/10 bg-[#020408]">
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-16 space-y-3">
            ...
            <p className="text-white/80 font-normal uppercase tracking-widest text-sm italic font-mono pt-4">Node Intelligence Archive</p>
          </div>
