        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button className="relative px-10 py-4 bg-white text-black font-bold text-base md:text-lg rounded-2xl transition-all hover:scale-[1.03] active:scale-95 shadow-xl uppercase tracking-tight italic flex items-center gap-3">
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button className="relative px-12 py-5 bg-white text-black font-bold text-lg rounded-xl transition-all shadow-[0_15px_40px_-15px_rgba(219,39,119,0.5)] uppercase tracking-tight italic hover:-translate-y-1">
