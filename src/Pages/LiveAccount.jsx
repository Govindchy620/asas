      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-24 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col items-center gap-6">
            <button className="px-12 py-5 rounded-full bg-white text-black font-black text-lg hover:bg-emerald-400 transition-all shadow-[0_20px_60px_-15px_rgba(16,185,129,0.4)] hover:-translate-y-1 active:scale-95">
            ...
            <div className="flex flex-col justify-center space-y-8 lg:p-8 text-center lg:text-left">
               ...
               <div className="space-y-6 text-base text-slate-400 leading-relaxed font-light italic">
                 ...
                 <div className="pt-6 flex flex-col gap-6 items-center lg:items-start">
                    <button className="px-10 py-4 rounded-2xl bg-white text-black font-bold text-base hover:bg-emerald-400 transition-all shadow-[0_15px_40px_-15px_rgba(16,185,129,0.4)] hover:-translate-y-1">
