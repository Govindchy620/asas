          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex flex-col items-center gap-6">
              <div className="group relative">
                <button className="relative px-12 py-5 bg-amber-500 text-black font-black text-lg uppercase tracking-tight hover:bg-white transition-all active:scale-95 shadow-[0_15px_40px_-15px_rgba(245,158,11,0.4)]">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 bg-black border border-white/5 shadow-2xl overflow-hidden group rounded-2xl">
                  ...
                  <div className="space-y-6">
                     ...
                     <button className="w-full py-4 bg-white text-black font-black hover:bg-amber-500 transition-all text-sm uppercase tracking-tight rounded-xl shadow-lg shadow-amber-500/10">
                        Open Demo Account
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                <button className="relative px-12 py-5 bg-white text-black font-black text-lg uppercase tracking-tight hover:bg-amber-500 transition-all shadow-[0_20px_60px_-15px_rgba(245,158,11,0.4)] rounded-2xl">
