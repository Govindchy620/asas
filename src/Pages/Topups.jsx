      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-24 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col items-center gap-6">
            <button className="px-10 py-4 rounded-2xl bg-white text-black font-bold text-base hover:bg-emerald-400 transition-all shadow-[0_15px_40px_-15px_rgba(16,185,129,0.4)] hover:-translate-y-1 active:scale-95">
      ...
      <section className="py-24 bg-black relative">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-10">
          ...
          <div className="space-y-8 pt-4">
              <button className="px-12 py-5 rounded-2xl bg-white text-black font-bold text-lg hover:bg-emerald-400 transition-all shadow-[0_20px_60px_-15px_rgba(16,185,129,0.4)] hover:-translate-y-1">
                Top Up Now
              </button>
