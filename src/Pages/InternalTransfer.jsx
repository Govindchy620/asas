    ...
    <div className="bg-[#050212] text-white font-sans selection:bg-purple-500/30 overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-2 pb-3 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-500/20 border border-purple-500/50 backdrop-blur-xl mb-8">
            ...
            <span className="text-xs font-normal uppercase tracking-[0.2em] text-white">Account Synapse v11.0</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
               <div className="space-y-6">
                 <h2 className="text-3xl md:text-5xl font-normal text-white uppercase tracking-tight leading-tight italic border-l-4 border-purple-500 pl-4">Internal Transfer <br/> Process Explained</h2>
               ...
               <div className="relative border border-white/20 shadow-2xl bg-[#0B0E2A] overflow-hidden rounded-3xl">
                 ...
                 <div className="absolute bottom-6 left-6 right-6 p-6 bg-black/90 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl">
                    ...
                    <div className="mt-4 flex items-center gap-3">
                      ...
                      <span className="text-purple-400 font-normal uppercase tracking-widest text-[10px]">Direct Server Fund Movement</span>
                    </div>
                 </div>
               </div>
            </div>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 text-center space-y-4">
            <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase italic leading-tight">Why Use Internal <br/> Fund Transfer?</h2>
            <p className="text-cyan-400 text-sm font-normal uppercase tracking-[0.2em]">The Strategic Edge in Forex</p>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-8 space-y-10">
               <div className="space-y-4">
                 <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic">Key Features of our <br/> Internal System</h2>
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 bg-black border border-purple-500/50 shadow-2xl overflow-hidden group rounded-3xl">
                  ...
                  <h3 className="text-xl font-normal text-white mb-6 tracking-tight uppercase border-b border-white/20 pb-4">Instant Rebalance</h3>
                  <div className="space-y-6">
                     ...
                     <button 
                        onClick={() => window.open('https://trade.FXCELITE.com/login', '_blank')}
                        className="w-full py-4 bg-white text-black font-normal hover:bg-purple-500 hover:text-white transition-all text-sm shadow-xl shadow-purple-500/20 uppercase tracking-tight italic rounded-xl">
                        Login to Dashboard
                     </button>
                  </div>
               </div>
      ...
      <section className="py-24 relative bg-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase italic leading-tight">Internal Transfer <br/> Step by Step</h2>
            <p className="text-purple-400 text-sm font-normal uppercase tracking-[0.2em]">The secure movement sequence</p>
          </div>
          ...
          <div className="grid lg:grid-cols-5 gap-6 relative">
            ...
            {[
              ...
              <div key={i} className="group relative p-6 bg-white/[0.05] border border-white/10 hover:border-purple-500/50 transition-all duration-500 text-center rounded-2xl shadow-xl mt-6 lg:mt-0">
                 <div className="absolute -top-5 left-1/2 -translate-x-1/2 w-10 h-10 bg-black border-2 border-purple-500/50 flex items-center justify-center font-normal text-white text-sm group-hover:bg-purple-500 group-hover:text-white transition-all rounded-lg">
                    {step.n}
                 </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12">
             <div className="p-8 md:p-10 rounded-3xl bg-black border border-white/20 relative group overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 space-y-8">
                   <div className="flex items-center gap-4">
                      ...
                      <h2 className="text-2xl font-normal text-white tracking-tight uppercase italic underline decoration-purple-500 decoration-4 underline-offset-[8px]">Security & Reliability</h2>
                   </div>
             ...
             <div className="space-y-10 lg:p-8">
                <div className="space-y-4">
                  <h2 className="text-3xl md:text-4xl font-normal text-white tracking-tight uppercase italic leading-tight">Who is Internal <br/> Transfer For?</h2>
                  <p className="text-cyan-400 font-normal uppercase tracking-[0.2em] text-xs font-mono">Precision Allocation Profiles</p>
                </div>
      ...
      <section className="py-24 bg-[#050212] text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic">Why FXCELITE is the Best <br/> Choice for Transfers?</h2>
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button 
                  onClick={() => window.open('https://trade.FXCELITE.com/login', '_blank')}
                  className="relative px-12 py-5 bg-white text-black font-normal text-lg transition-all shadow-[0_15px_40px_-15px_rgba(139,92,246,0.6)] uppercase tracking-tight italic rounded-xl hover:-translate-y-1">
                  Start an Internal Transfer
                </button>
              </div>
              <div className="space-y-4">
                <p className="text-purple-400 font-normal uppercase tracking-[0.3em] text-xs italic font-mono">Your capital, perfectly balanced. Experience the speed now!</p>
      ...
      <section className="py-24 border-t border-white/10 bg-black">
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-16 space-y-3">
            <h2 className="text-3xl md:text-4xl font-normal text-white tracking-tight uppercase italic underline decoration-purple-500 decoration-4 underline-offset-[8px]">Transfer FAQ</h2>
