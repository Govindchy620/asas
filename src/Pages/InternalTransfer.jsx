            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 bg-black border border-purple-500/50 shadow-2xl overflow-hidden group rounded-3xl">
                  ...
                  <div className="space-y-6">
                     ...
                     <button 
                        onClick={() => window.open('https://trade.fxcelite.com/login', '_blank')}
                        className="w-full py-4 bg-white text-black font-bold hover:bg-purple-500 hover:text-white transition-all text-sm shadow-xl shadow-purple-500/20 uppercase tracking-tight italic rounded-xl">
                        Login to Dashboard
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button 
                  onClick={() => window.open('https://trade.fxcelite.com/login', '_blank')}
                  className="relative px-12 py-5 bg-white text-black font-bold text-lg transition-all shadow-[0_15px_40px_-15px_rgba(139,92,246,0.6)] uppercase tracking-tight italic rounded-xl hover:-translate-y-1">
