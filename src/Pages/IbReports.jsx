...
export default function IbReports() {
  return (
    <div className="bg-[#0B0E14] text-white font-sans selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-2 pb-3 overflow-hidden border-b border-white/10">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center space-y-8">
          ...
          <h1 className="text-4xl md:text-6xl font-normal text-white leading-[1.1] tracking-tight uppercase italic">
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button 
                ...
                className="relative px-10 py-4 bg-white text-black font-normal text-base md:text-lg rounded-xl uppercase tracking-tight hover:bg-blue-600 hover:text-white transition-all active:scale-95 shadow-xl flex items-center gap-2">
                Access Your IB Reports <BarChart3 size={20} className="ml-2" />
              </button>
            </div>
            <p className="text-blue-400 text-sm font-normal uppercase tracking-[0.2em] italic font-mono animate-pulse">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-12">
               <div className="space-y-6">
                 <h2 className="text-3xl md:text-5xl font-normal text-white uppercase tracking-tight leading-tight italic border-l-4 border-blue-600 pl-4">What Information <br/> Is Included?</h2>
               ...
               <div className="grid gap-4">
                 {[
                   ...
                   <div key={i} className="flex gap-5 group items-start p-6 bg-white/5 border border-white/10 hover:bg-white/10 transition-all rounded-2xl">
                      ...
                      <div>
                        <span className="text-white text-lg font-normal uppercase tracking-tight italic block mb-1">{item.l}</span>
               ...
               <div className="relative border border-white/20 shadow-2xl bg-[#0B0E2A] p-1 rounded-3xl overflow-hidden">
                 ...
                 <div className="absolute bottom-6 left-6 right-6 p-6 bg-black/90 border border-white/20 backdrop-blur-xl shadow-xl rounded-xl">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-blue-400 font-mono font-normal uppercase tracking-[0.2em] text-[10px]">Real-Time Pulse Sync: Online</span>
                    </div>
                 </div>
               </div>
            </div>
      ...
      <section className="py-24 relative border-y border-white/10 bg-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 text-center space-y-4">
            <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase italic leading-tight">Why Use Detailed <br/> Forex IB Reports?</h2>
            <p className="text-blue-400 text-sm font-normal uppercase tracking-[0.2em] font-mono">[ Competitive Edge Acquisition ]</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/20 border border-white/20 rounded-xl overflow-hidden shadow-xl">
            ...
            //   { title: "Real-Time Access", desc: "Have access to your IB earnings online at any time. You will never be in the dark about your business.", icon: <Zap /> },
              ...
              <div key={i} className="group p-8 bg-[#0B0E14] hover:bg-blue-900/20 transition-all duration-500 flex flex-col items-start relative overflow-hidden">
                ...
                <h3 className="text-xl font-normal text-white mb-3 uppercase tracking-tight italic relative z-10">{item.title}</h3>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-8 space-y-10">
               <div className="space-y-4">
                 <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic underline decoration-blue-600 decoration-4 underline-offset-[8px]">Key Features of <br/> the Reporting Engine</h2>
               ...
               <div className="grid md:grid-cols-2 gap-5">
                 {[
                   ...
                   <div key={i} className="group p-6 bg-white/5 border border-white/10 hover:border-blue-500/50 transition-all duration-300 relative shadow-lg rounded-2xl overflow-hidden">
                      ...
                      <h4 className="text-base font-normal text-white mb-2 uppercase tracking-tight italic relative z-10">{feature.t}</h4>
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32 space-y-6">
               <div className="relative p-8 bg-black border border-white/20 shadow-2xl overflow-hidden group rounded-3xl">
                  ...
                  <h3 className="text-xl font-normal text-white mb-6 tracking-tight uppercase border-b border-white/20 pb-4 font-mono">Archive Access</h3>
                  <div className="space-y-6 relative z-10">
                     <p className="text-base text-blue-400 font-normal leading-tight italic uppercase">
                     ...
                     <button 
                        onClick={() => window.open('https://trade.FXCELITE.com/login', '_blank')}
                        className="w-full py-4 bg-white text-black font-normal hover:bg-blue-600 hover:text-white transition-all text-sm uppercase tracking-tight italic rounded-xl shadow-lg">
                        Explore Reports
                     </button>
                  </div>
               </div>
               ...
               <div className="p-4 bg-blue-900/20 border border-blue-500/40 text-center rounded-xl">
                 <p className="text-blue-300 text-xs font-normal uppercase tracking-[0.2em] italic font-mono animate-pulse">System Status: Nominal</p>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 relative bg-black border-y border-white/10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase italic leading-tight">How to Download <br/> IB Commission Reports</h2>
            <p className="text-blue-400 text-sm font-normal uppercase tracking-[0.2em] font-mono">Extraction Sequence</p>
          ...
          <div className="grid lg:grid-cols-3 gap-8 relative">
            {[
              ...
              <div key={i} className="group relative p-8 bg-[#0B0E14] border border-white/10 hover:border-blue-500/50 transition-all duration-500 text-center shadow-xl rounded-3xl mt-6 lg:mt-0">
                 <div className="absolute -top-5 left-1/2 -translate-x-1/2 w-10 h-10 bg-black border-2 border-white/20 flex items-center justify-center font-normal text-white text-sm group-hover:text-blue-400 group-hover:border-blue-500 transition-all rounded-full">
                    {step.n}
                 </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
             <div className="p-8 md:p-10 bg-[#0B0E14] border border-white/20 relative group overflow-hidden shadow-2xl rounded-3xl">
                ...
                <div className="relative z-10 space-y-8">
                   <div className="flex items-center gap-4">
                      ...
                      <h2 className="text-2xl font-normal text-white tracking-tight uppercase italic underline decoration-blue-500 decoration-4 underline-offset-[8px]">Security & <br/> Confidentiality</h2>
                   </div>
             ...
             <div className="space-y-10 lg:p-8">
                <div className="space-y-4">
                  <h2 className="text-3xl md:text-4xl font-normal text-white tracking-tight uppercase italic leading-tight">Who Needs Detailed <br/> IB Reports?</h2>
                  <p className="text-blue-400 font-normal uppercase tracking-[0.2em] text-xs font-mono">[ Advanced Intelligence Profiles ]</p>
                </div>
                <div className="grid gap-4">
                   {[
      ...
      <section className="py-24 bg-black text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic">BACK OFFICE <br/> <span className="text-blue-400 underline decoration-white decoration-4">EXCELLENCE</span></h2>
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button 
                  onClick={() => window.open('https://trade.FXCELITE.com/login', '_blank')}
                  className="relative px-12 py-4 bg-white text-black font-normal text-lg transition-all shadow-[0_15px_40px_-15px_rgba(30,58,138,0.5)] uppercase tracking-tight italic rounded-xl hover:-translate-y-1">
                  Check Your IB Reports
                </button>
              </div>
              <div className="space-y-4">
                <p className="text-blue-400 font-normal uppercase tracking-[0.2em] text-xs italic font-mono">Master your data. turn insights into actionable growth today!</p>
      ...
      <section className="py-24 border-t border-white/10 bg-[#080B11]">
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-16 space-y-3">
            <h2 className="text-3xl md:text-4xl font-normal text-white tracking-tight uppercase italic font-mono underline decoration-blue-500 decoration-4 underline-offset-[8px]">[ KNOWLEDGE BASE ]</h2>
            <p className="text-white/80 font-normal uppercase tracking-widest text-sm italic font-mono pt-4">Technical Archive Sigma-12</p>
          </div>
