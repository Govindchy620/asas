          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button 
                ...
                className="relative px-10 py-4 bg-white text-black font-bold text-base md:text-lg rounded-xl uppercase tracking-tight hover:bg-blue-600 hover:text-white transition-all active:scale-95 shadow-xl flex items-center gap-2">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32 space-y-6">
               <div className="relative p-8 bg-black border border-white/20 shadow-2xl overflow-hidden group rounded-3xl">
                  ...
                  <div className="space-y-6 relative z-10">
                     ...
                     <button 
                        onClick={() => window.open('https://trade.fxcelite.com/login', '_blank')}
                        className="w-full py-4 bg-white text-black font-bold hover:bg-blue-600 hover:text-white transition-all text-sm uppercase tracking-tight italic rounded-xl shadow-lg">
                        Explore Reports
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button 
                  onClick={() => window.open('https://trade.fxcelite.com/login', '_blank')}
                  className="relative px-12 py-4 bg-white text-black font-bold text-lg transition-all shadow-[0_15px_40px_-15px_rgba(30,58,138,0.5)] uppercase tracking-tight italic rounded-xl hover:-translate-y-1">
