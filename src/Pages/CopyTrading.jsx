        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button className="relative px-10 py-4 rounded-full bg-white text-black font-bold text-base transition-all hover:scale-[1.02] active:scale-95 shadow-xl">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 rounded-3xl bg-[#0B0E2A] border border-white/10 shadow-2xl overflow-hidden group">
                  ...
                  <div className="space-y-6 relative z-10">
                     ...
                     <button className="w-full py-4 rounded-2xl bg-white text-black font-bold hover:bg-purple-500 hover:text-white transition-all text-base shadow-lg">
                        Open a Demo Account
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button className="relative px-12 py-5 rounded-2xl bg-white text-black font-bold text-lg transition-all shadow-[0_20px_60px_-15px_rgba(168,85,247,0.4)] hover:-translate-y-1">
