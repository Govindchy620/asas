        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button className="relative px-10 py-4 rounded-2xl bg-white text-black font-bold text-base transition-all hover:scale-[1.03] active:scale-95 shadow-2xl flex items-center gap-3">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 rounded-3xl bg-[#0B0E2A] border border-white/10 shadow-2xl overflow-hidden group">
                  ...
                  <div className="space-y-6">
                     ...
                     <button className="w-full py-4 rounded-2xl bg-white text-black font-bold hover:bg-indigo-500 transition-all text-sm shadow-xl shadow-indigo-500/20 uppercase tracking-tight italic">
                        Try Demo Mode
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-5xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-8">
              <div className="relative group">
                ...
                <button className="relative px-12 py-5 rounded-3xl bg-white text-black font-bold text-lg md:text-xl transition-all shadow-[0_20px_60px_-15px_rgba(99,102,241,0.4)] uppercase tracking-tight italic hover:-translate-y-1">
