          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button className="relative px-10 py-4 bg-white text-black font-bold text-base md:text-lg rounded-xl transition-all hover:scale-[1.02] active:scale-95 shadow-xl uppercase tracking-tight flex items-center gap-2 italic">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 bg-black border border-teal-500/50 shadow-[0_0_50px_-10px_rgba(45,212,191,0.3)] group rounded-3xl overflow-hidden">
                  ...
                  <div className="space-y-6 relative z-10">
                     ...
                     <button className="w-full py-4 bg-white text-black font-bold hover:bg-teal-400 transition-all text-sm uppercase tracking-tight italic rounded-xl shadow-lg">
                        Unlock Dashboard
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button className="relative px-12 py-5 bg-white text-black font-bold text-lg transition-all shadow-[0_15px_40px_-15px_rgba(45,212,191,0.6)] uppercase tracking-tight italic hover:-translate-y-1 rounded-xl">
