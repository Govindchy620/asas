    ...
    <div className="bg-[#020617] text-slate-300 font-sans selection:bg-blue-500/30 overflow-x-hidden">
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button 
                ...
                className="relative px-10 py-4 bg-white text-black font-normal text-base transition-all hover:bg-blue-600 hover:text-white active:scale-95 flex items-center gap-3 uppercase tracking-tight italic">
                Download MetaTrader 5 <Download size={20} />
              </button>
            </div>
            <p className="text-blue-400 text-sm font-normal uppercase tracking-[0.2em] italic animate-pulse font-mono">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
               <div className="space-y-6">
                 <h2 className="text-3xl md:text-4xl font-normal text-white uppercase tracking-tight leading-tight italic border-l-4 border-blue-600 pl-4">MT5 Platform <br/> Explained</h2>
               ...
               <div className="relative border border-white/10 shadow-2xl bg-[#0B0E2A]">
                 ...
                 <div className="absolute bottom-6 left-6 right-6 p-6 bg-black/80 border border-blue-500/30 backdrop-blur-xl z-10">
                    ...
                    <div className="mt-4 flex items-center gap-3">
                      ...
                      <span className="text-white text-lg font-normal tracking-tight uppercase italic">Depth of Market (DOM)</span>
                    </div>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 text-center space-y-4">
            <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase italic leading-tight">Why Choose FXCELITE <br/> for MT5 Trading?</h2>
            <p className="text-blue-500 text-sm font-normal uppercase tracking-[0.2em] font-mono">[ Execution Environment Optimization ]</p>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-8 space-y-10">
               <div className="space-y-4">
                 <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic">Key Features of <br/> MetaTrader 5</h2>
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 bg-[#0B0E2A] border border-blue-500/30 shadow-2xl overflow-hidden group">
                  ...
                  <h3 className="text-xl font-normal text-white mb-6 tracking-tight uppercase border-b border-white/10 pb-4 italic">Virtual Mastery</h3>
                  <div className="space-y-6">
                     <p className="text-base text-blue-400 font-normal leading-tight italic">
                     ...
                     <button 
                        onClick={() => window.open('https://trade.FXCELITE.com/register', '_blank')}
                        className="w-full py-4 bg-white text-black font-normal hover:bg-blue-600 hover:text-white transition-all text-sm uppercase tracking-tight italic">
                        Open Demo Account
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 relative group">
                ...
                <div className="relative border border-white/10 p-8 bg-white/[0.01]">
                    <div className="flex items-center gap-5 mb-8">
                      ...
                      <h2 className="text-2xl font-normal text-white uppercase italic tracking-tight">Automated <br/> Trading</h2>
                    </div>
                    <div className="space-y-4">
                       <div className="p-5 border border-white/5 bg-white/[0.03] hover:border-blue-500/50 transition-colors">
                          <h4 className="text-white font-normal uppercase text-xs tracking-widest mb-1 flex items-center gap-2">
            ...
            <div className="order-1 lg:order-2 space-y-8">
               <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic underline decoration-blue-600 decoration-4 underline-offset-[8px]">Automated <br/> Trading Platform</h2>
      ...
      <section className="py-24 relative border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase italic leading-tight">How to Trade <br/> on MetaTrader 5</h2>
            <p className="text-blue-500 text-sm font-normal uppercase tracking-[0.2em] font-mono">[ Deployment Command Sequence ]</p>
          </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12 relative z-10">
              {[
                ...
                <div key={i} className="group relative">
                  ...
                  <h3 className="text-xl font-normal text-white mb-3 uppercase tracking-tight italic">{step.t}</h3>
      ...
      <section className="py-24 bg-[#020617] text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           <h2 className="text-3xl md:text-5xl font-normal text-white tracking-tight uppercase leading-tight italic">Why FXCELITE is the Best <br/> Choice for MT5?</h2>
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button 
                  onClick={() => window.open('https://trade.FXCELITE.com/register', '_blank')}
                  className="relative px-12 py-4 bg-white text-black font-normal text-base transition-all shadow-[0_15px_40px_-15px_rgba(37,99,235,0.4)] uppercase tracking-tight italic hover:-translate-y-1">
                  Sign Up for MT5 Now
                </button>
              </div>
              <div className="space-y-4">
                <p className="text-blue-400 font-normal uppercase tracking-[0.3em] text-xs italic font-mono">Command the markets with the best tools.</p>
      ...
      <section className="py-24 border-t border-white/5 bg-black">
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-16 space-y-3">
            <h2 className="text-3xl md:text-4xl font-normal text-white tracking-tight uppercase italic font-mono">[ MT5 FAQ ]</h2>
