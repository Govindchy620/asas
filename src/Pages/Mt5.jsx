          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button 
                ...
                className="relative px-10 py-4 bg-white text-black font-bold text-base transition-all hover:bg-blue-600 hover:text-white active:scale-95 flex items-center gap-3 uppercase tracking-tight italic">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 bg-[#0B0E2A] border border-blue-500/30 shadow-2xl overflow-hidden group">
                  ...
                  <div className="space-y-6">
                     ...
                     <button 
                        onClick={() => window.open('https://trade.fxcelite.com/register', '_blank')}
                        className="w-full py-4 bg-white text-black font-bold hover:bg-blue-600 hover:text-white transition-all text-sm uppercase tracking-tight italic">
                        Open Demo Account
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button 
                  onClick={() => window.open('https://trade.fxcelite.com/register', '_blank')}
                  className="relative px-12 py-4 bg-white text-black font-bold text-base transition-all shadow-[0_15px_40px_-15px_rgba(37,99,235,0.4)] uppercase tracking-tight italic hover:-translate-y-1">
                  Sign Up for MT5 Now
                </button>
              </div>
              <div className="space-y-4">
