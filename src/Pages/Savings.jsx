        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative group">
              ...
              <button className="relative px-10 py-4 bg-white text-black font-bold text-base md:text-lg rounded-2xl transition-all hover:scale-[1.03] active:scale-95 shadow-xl uppercase tracking-tight italic flex items-center gap-2">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
               <div className="relative p-8 rounded-3xl bg-[#022c22] border border-amber-500/50 shadow-2xl overflow-hidden group">
                  ...
                  <div className="space-y-6 relative z-10">
                     ...
                     <button className="w-full py-4 rounded-xl bg-white text-black font-bold hover:bg-amber-400 transition-all text-sm shadow-xl shadow-amber-500/20 uppercase tracking-tight italic">
                        Open a Live Account
                     </button>
                  </div>
               </div>
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
           ...
           <div className="pt-6 flex flex-col items-center gap-6">
              <div className="relative group">
                ...
                <button className="relative px-12 py-5 bg-white text-black font-bold text-lg rounded-2xl transition-all shadow-xl uppercase tracking-tight italic hover:-translate-y-1">
                  Deposit Funds
                </button>
              </div>
              <div className="space-y-4">
